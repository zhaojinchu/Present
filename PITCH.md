...
**0:25 to 0:45, how it works.** Today screen on the projector. "Your schedule comes from your calendar in one upload. Two minutes before each class a window opens. You present: a photo from the room, on time for ten minutes, late after that, and if you never post your friends see a miss and you owe them an explanation. Your streak counts on-time presents. While your window is open the app is one dark screen: present to unlock. And you can put your friends in a circle, where a miss costs everyone."

**0:45 to 1:50, live demo.** Start 15-122 from the dev panel. Every phone turns into one dark screen: "15-122. Present to unlock." with a countdown and one button. P1 says "you cannot scroll until you show up" and presents: the app comes back in colour. P1 taps the circles icon in the top bar and picks "Hack House": one row under the header, streak 8, "15-122 now · 1 of 4 present". P2 and P3 present; the row ticks to "3 of 4" live and the feed stacks them into one deck: "Priya and Jordan are in 15-122", swipe to see each. P1 taps the row: roll call with four avatars, three green ticks, Alex still grey. Back. Alex's phone stays dark; Alex does not present. End the window: "Alex missed 15-122", the streak that was 10 shows 0, and under it the circle verdict card: "Alex owes the circle: buys everyone boba", with Fair enough / Not buying it / I saw them. P1 opens the circle: the circle streak reads 0, "Streak lost · everyone starts over", and the standings put Alex last in red. Alex types "slept in" as the first comment. P2 taps "Not buying it". Reactions land.
...
**2:15 to 2:40, why it is original, and the design.** "The photo moment looks like the app you are thinking of, on purpose: it proved people will take a photo when told to. Everything around the photo is ours. Circles, where a miss costs everyone: one streak for the whole house, stakes you set yourselves, and your friends as the jury on your excuse. Roll call that fills in live as people walk in. One card for everyone in the same lecture. We designed it after tearing down Instagram, Strava and X: one spot colour for the streak, hairlines instead of cards, tabular numbers."

**2:40 to 2:50, close.** "Present. Your friends know if you showed up, and your circle makes sure you do. It's live at present.expo.app; add us at the table."

Stop talking at 2:50. Leave 10 seconds for the judges to start questions.

Likely questions and the one-line answers:
- "Isn't this just [the daily-photo app]?" "The camera moment is, deliberately. Everything else isn't: it verifies nothing and nothing happens if you don't post. Present knows your schedule, takes roll call for the room, lets a circle put stakes on showing up, and shows a miss when you don't. It is a coordination tool with a photo as the receipt." Then stop. Do not list features.

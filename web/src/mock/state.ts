    ...
    groups: [
      {
        ...
        emoji: '🏠',
        invite_code: 'BOBA26',
        forfeit_text: 'buys everyone boba',
        created_by: MOCK_ME_ID,
        created_at: iso(-9 * 24 * HOUR, base),
        members: [
          { id: MOCK_ME_ID, username: 'alex', display_name: 'Alex Chen', avatar_url: null, streak: 10, posted_today: true },
          { id: PRIYA, username: 'priya', display_name: 'Priya Natarajan', avatar_url: null, streak: 11, posted_today: true },
          { id: JORDAN, username: 'jordan', display_name: 'Jordan Lee', avatar_url: null, streak: 11, posted_today: true },
          { id: SAM, username: 'sam', display_name: 'Sam Okafor', avatar_url: null, streak: 0, posted_today: false },
        ],
        streak: 0,
        best_streak: 12,
        week: { made: 21, total: 23, on_time: 19, late: 2, missed: 2, upcoming: 6 },
        standings: [
          { id: MOCK_ME_ID, made: 6, total: 6, on_time: 6, late: 0, missed: 0 },
          { id: PRIYA, made: 6, total: 6, on_time: 5, late: 1, missed: 0 },
          { id: JORDAN, made: 5, total: 5, on_time: 5, late: 0, missed: 0 },
          { id: SAM, made: 4, total: 6, on_time: 3, late: 1, missed: 2 },
        ],
        forfeits: [{ id: 'forfeit-1', miss_id: 'miss-1', user_id: SAM, status: 'owed', paid_by: null, paid_at: null, created_at: iso(-25 * HOUR + 70 * MIN, base), course_code: '79-104', starts_at: iso(-25 * HOUR, base) }],
        votes: [
          { miss_id: 'miss-1', user_id: PRIYA, fair: true },
          { miss_id: 'miss-1', user_id: JORDAN, fair: false },
        ],
        vouches: [],
        excused_miss_ids: [],
      },
      {
        ...
        streak: 3,
        best_streak: 3,
        week: { made: 9, total: 9, on_time: 8, late: 1, missed: 0, upcoming: 3 },
        standings: [
          { id: MOCK_ME_ID, made: 3, total: 3, on_time: 3, late: 0, missed: 0 },
          { id: PRIYA, made: 3, total: 3, on_time: 2, late: 1, missed: 0 },
          { id: JORDAN, made: 3, total: 3, on_time: 3, late: 0, missed: 0 },
        ],
        forfeits: [],
        votes: [],
        vouches: [],
